    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="col-md-4">
          ...
          <p>Our goal is not to host all the forms of the world, so we try to make it easy for you to <a href="http://kinto.readthedocs.io/en/latest/core/reference/installation.html#installation">host your own servers</a>.</p>
        </div>
        <div className="col-md-4">
